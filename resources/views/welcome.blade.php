...
<head>
  ...
  <title>Cek Pohon Manggamu</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Solusi Untuk Tanaman Mangga Anda</h1>
          <h2>Anda dapat mengetahui penyakit yang menyerang pohon mangga anda dan memberikan solusi untuk masalah yang terjadi</h2>
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img aos-init aos-animate" data-aos="zoom-in" data-aos-delay="200">
          <img src="assets/assets/img/simangocheck.png" class="img-fluid animated w-75" alt="">
        </div>
      </div>
    </div>
