...
<div id="layoutSidenav">
    ...
    <div class="container-fluid px-4 mt-5">
        <h1 class="mt-4">Create Konsultasi</h1>
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Create Konsultasi</li>
        </ol>
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form>
                    <div class="form-group">
                        <label for="selectOptions">Pilih Gejala:</label>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('konsultasi') }}" class="btn btn-success">Create</a>
                </div>
