...
<div id="layoutSidenav">
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4">Hasil Konsultasi Hama</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('dashboard-user') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Hasil Konsultasi Hama</li>
        </ol>
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between">
                <h5 class="my-0"><i class="fas fa-table me-1"></i>Data Table Hasil Konsultasi Hama</h5>
                <div class="dropdown">
            ...
            <div class="card-body">
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        $no=1;
                        @endphp
                        @foreach ($hasilHama as $h)
                        <tr>
                            <td>{{ $h->user_id }}</td>
                            <td>{{ $h->datetime }}</td>
                            <td>{{ $h->hama->nama_hama }}</td>
                            <td>
                                @foreach ($h->gejalaHama as $g )
