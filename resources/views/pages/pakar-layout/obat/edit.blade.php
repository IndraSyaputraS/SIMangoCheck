            ...
            <div class="card-body">
                <form action="{{ route('obat.update', ['id'=>$obat->id]) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nama" type="text" class="form-control w-25" value="{{ $obat->nama_obat }}" id="exampleFormControlInput1" placeholder="Nama">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Deskripsi Obat</label>
                        <textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Deskripsi">{{ $obat->deskripsi_obat }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Harga</label>
                        <input name="harga" type="text" class="form-control w-25" value="{{ $obat->harga_obat }}" id="exampleFormControlInput1" placeholder="Harga">
                    </div>
